...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .source-link {{ display: inline-flex; align-items: center; gap: 0.4rem; color: #414141; text-underline-offset: 0.2rem; }}
    .source-link svg {{ width: 0.9rem; height: 0.9rem; fill: currentColor; }}
    ...
    .autoconfigure {{ display: inline-flex; align-items: center; gap: 0.55rem; margin-bottom: 1.5rem; padding: 0.85rem 1rem; border: 1px solid #111; background: #fff; box-shadow: 3px 3px 0 #111; color: #111; font-size: 0.68rem; font-weight: 700; letter-spacing: 0.05em; text-decoration: none; transition: transform 120ms ease, box-shadow 120ms ease; }}
    .autoconfigure:hover {{ box-shadow: 1px 1px 0 #111; transform: translate(2px, 2px); }}
    .autoconfigure:focus-visible {{ outline: 2px solid #111; outline-offset: 4px; }}
  ...
  <div class="shell">
    <header>
      ...
      <div class="header-actions">
        <a class="source-link" href="https://github.com/wasix-org/epoxy-tls" target="_blank" rel="noopener noreferrer"><svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82A7.65 7.65 0 0 1 8 3.52c.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8Z"/></svg>GitHub Source Code</a>
